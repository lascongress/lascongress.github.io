  ...
  const MobileMenu = () => {
    ...
    return (
      <div className="fixed inset-0 z-50">
        ...
        {/* Right-side drawer */}
        <div
          className="absolute right-0 top-0 h-full w-2/3 sm:w-1/2 lg:w-1/3 min-w-[280px] max-w-[520px] bg-neutral-300 text-black shadow-xl flex flex-col transition-transform duration-300 ease-out"
          role="dialog"
          aria-modal="true"
      ...
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className={`max-w-screen px-2 md:flex md:items-center md:w-auto ${isOpen ? "block" : "hidden"}`}>
          <div className="text-sm md:flex-grow">
            <div className="block mt-4 p-2 md:inline-block md:mt-0 hover:underline cursor-pointer" onClick={toggleMenu}>
              Menu
            </div>
          </div>
        </div>
